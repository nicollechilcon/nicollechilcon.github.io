  ...
  return (
    <section className="about-section">
      ...
      <article>
        ...
        <p>
          I am a UX designer based in <strong>Lima, Peru.</strong>
          ...
          <br/><br/>
          My goal as a UX designer is to create a bridge between a product and its users.
          its users. I design this portfolio that has experiences and stories that people can empathize and interact with.
          <br/><br/>
